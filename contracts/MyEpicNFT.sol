...
contract MyEpicNFT is ERC721URIStorage {
    ...
    string[] firstWords = ["bitcoin ", "ether ", "link ", "ripple ", "cardano ", "thegraph "];
    string[] secondWords = ["belize ", "austria ", "singapore ", "iceland ", "norway ", "senegal "];
    string[] thirdWords = ["burrito ", "pizza ", "padthai ", "queso ", "cheesecake ", "otoro "];
